    ...
    <section>
      <div className="container-xl lg:container m-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 rounded-lg">
            <InfoBox heading="For Renters" backgroundColor="bg-gray-100" buttonInfo={{ text: "Search Homes", link: "/properties", backgroundColor: "bg-black" }} >
                Find you dream rental property, Bookmark properties and contact owners.
            </InfoBox>
